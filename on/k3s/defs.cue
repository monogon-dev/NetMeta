...
import (
	...
	traefik "github.com/monogon-dev/NetMeta/on/k3s/traefik:k8s"

	clickhouseOperator "github.com/monogon-dev/NetMeta/on/k3s/clickhouse-operator:k8s"
	clickhouse "github.com/monogon-dev/NetMeta/on/k3s/clickhouse"

	strimziKafkaOperator "github.com/monogon-dev/NetMeta/on/k3s/strimzi-kafka-operator:k8s"
	kafka "github.com/monogon-dev/NetMeta/on/k3s/kafka"

	// Dashboards
	grafana_dashboards "github.com/monogon-dev/NetMeta/deploy/dashboards"

	grafana "github.com/monogon-dev/NetMeta/on/k3s/grafana"

	schema "github.com/monogon-dev/NetMeta/deploy/single-node/schema"
	reconciler "github.com/monogon-dev/NetMeta/on/k3s/reconciler"

	risinfo "github.com/monogon-dev/NetMeta/on/k3s/risinfo"

	goflow "github.com/monogon-dev/NetMeta/on/k3s/goflow"

	portmirror "github.com/monogon-dev/NetMeta/on/k3s/portmirror"
)
