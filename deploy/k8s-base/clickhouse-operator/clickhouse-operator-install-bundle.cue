...
ClusterRole: "clickhouse-operator-kube-system": {
	// Template Parameters:
	//
	// NAMESPACE=kube-system
	// COMMENT=#
...
ClusterRoleBinding: "clickhouse-operator-kube-system": {
...
Deployment: "clickhouse-operator": {
	...
	// NAMESPACE=kube-system
	// COMMENT=
	// OPERATOR_IMAGE=altinity/clickhouse-operator:0.19.3
	// OPERATOR_IMAGE_PULL_POLICY=Always
	// METRICS_EXPORTER_IMAGE=altinity/metrics-exporter:0.19.3
	...
	spec: {
		...
		template: {
			...
			spec: {
				...
				containers: [{
					name:            "clickhouse-operator"
					image:           "altinity/clickhouse-operator:0.19.3"
					...
					image:           "altinity/metrics-exporter:0.19.3"
					imagePullPolicy: "Always"
					volumeMounts: [{
						name:      "etc-clickhouse-operator-folder"
						mountPath: "/etc/clickhouse-operator"
