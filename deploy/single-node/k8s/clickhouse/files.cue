...
ClickHouseInstallation: netmeta: spec: configuration: files: "IPProtocols.conf": #"""
	<yandex>
	    <dictionary>
...
ClickHouseInstallation: netmeta: spec: configuration: files: "EtherTypes.conf": #"""
	<yandex>
	    <dictionary>
...
ClickHouseInstallation: netmeta: spec: configuration: files: "TCPFlags.conf": #"""
	<yandex>
	    <dictionary>
	        <name>TCPFlags</name>
	        <source>
...
ClickHouseInstallation: netmeta: spec: configuration: files: "InterfaceNames.conf": #"""
	<yandex>
	    <dictionary>
