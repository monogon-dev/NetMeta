...
// TODO(fionera): Remove all static files if possible and replace with generated values
ClickhouseInstallation: netmeta: spec: configuration: files: "IPProtocols.dict": #"""
	    <yandex>
	        <dictionary>
...
ClickhouseInstallation: netmeta: spec: configuration: files: "IPProtocols.tsv": #"""
	0	NULL
	1	ICMP
	2	IGMP
	3	GGP
...
ClickhouseInstallation: netmeta: spec: configuration: files: "EtherTypes.dict": #"""
	<yandex>
	    <dictionary>
...
ClickhouseInstallation: netmeta: spec: configuration: files: "EtherTypes.tsv": #"""
	0	NULL
	2048	IPv4
	2054	ARP
	2114	Wake-on-LAN
...
ClickhouseInstallation: netmeta: spec: configuration: files: "TCPFlags.dict": #"""
	<yandex>
	    <dictionary>
	        <name>TCPFlags</name>
	        <source>
...
ClickhouseInstallation: netmeta: spec: configuration: files: "TCPFlags.tsv": #"""
	1	FIN
	2	SYN
	4	RST
	8	PSH
...
ClickhouseInstallation: netmeta: spec: configuration: files: "FlowMessage.proto": #"""
	syntax = "proto3";
	package netmeta;
...
ClickhouseInstallation: netmeta: spec: configuration: files: {
	let interfaceNames = (#GeneratedTSV & {
		#in: {
			name: "InterfaceNames"
			keys: [{
				name: "Device"
			...
			data: [ for e in #Config.interfaceMap {
				[e.device, "\(e.idx)", e.description]
			}]
		}
	}).#out
	for k, v in interfaceNames {
		"\(k)": v
	}
}
