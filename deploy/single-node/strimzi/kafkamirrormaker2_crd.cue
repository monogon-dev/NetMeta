...
k8s: crds: "kafkamirrormaker2s.kafka.strimzi.io": spec: {
						...
						properties: {
							...
							authentication: {
								...
								properties: {
									...
									maxTokenExpirySeconds: type:          "integer"
									passwordSecret: {
										type: "object"
										properties: {
				...
				mirrors: {
					...
					items: {
						...
						properties: {
							...
							topicsBlacklistPattern: type: "string"
							groupsPattern: type:          "string"
							groupsBlacklistPattern: type: "string"
						}
						required: [
							"sourceCluster",
							"targetCluster",
