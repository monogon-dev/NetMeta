...
k8s: crds: "clickhouseinstallationtemplates.clickhouse.altinity.com": spec: {
				...
				properties: {
					zookeeper: {
						...
						properties: {
							...
							session_timeout_ms: type:   "integer"
							operation_timeout_ms: type: "integer"
							root: type:                 "string"
